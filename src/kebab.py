...
def kebab_usage():
    ...
    print("vegan - tells wether the skewer contains all vegetables or not")
...
def kebab_calories(kebab, args):
    """
    Prints the amount of calories the skewer has
    :param kebab:
    :param args:
    :return:
    """
    print("The skewer has", skewer_calories(kebab.skewer), "calories.")

def kebab_vegan(kebab, args):
    """
    prints a message depending on if
    the function skewer_vegan returns True
    or False. It will tell us whether the skewer
    is vegan or not.
    :param kebab:
    :param args:
    :return:
